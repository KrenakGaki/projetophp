    ...
    setTimeout(() => {
      setProdutos([
        ...
        },
        {
          ...
          descricao: "12000 DPI, 7 botões programáveis",
          quantidade: 5,
          preco: 149.90,
          categoria: "Periféricos",
          fornecedor: "Games Store"
        },
        {
          id: 3,
          nome: "Teclado Mecânico",
          descricao: "Switch Blue, RGB completo",
          quantidade: 25,
          preco: 299.90,
          categoria: "Periféricos",
          fornecedor: "Tech Distribuidora"
  ...
  const handleSubmit = (e) => {
    ...
    if (editando) {
      setProdutos(prev => prev.map(p =>
        p.id === editando.id ? dadosParaEnviar : p
      ));
      alert("Produto atualizado com sucesso!");
    } else {
      setProdutos(prev => [...prev, dadosParaEnviar]);
